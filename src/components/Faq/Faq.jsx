...
const Faq = () => {
  ...
  <div className="collapse collapse-arrow mb-3 bg-base-200">
    ...
    <p className="text-custom-yellow">Answer</p>
      <p>We specialize in organizing a wide range of events, including corporate conferences, seminars, product launches, and more. Our experienced team tailors each event to meet your specific requirements.</p>
    </div>
  </div>
  <div className="collapse collapse-arrow mb-3 bg-base-200">
    <input type="radio" name="my-accordion-2" /> 
